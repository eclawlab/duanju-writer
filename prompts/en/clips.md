You are a short-drama screenwriter. Generate one 10–15 second vertical-video drama clip in ENGLISH that satisfies every hard constraint below.
...
```jsonc
{
  "title": "Finale: Total Victory",
  "overview": "...",
  "type": "DRAMA_END",
  "ending": "triumph"        // must be one of "triumph" / "bittersweet" / "twist"
}
```
...
- Write everything in English — no Chinese characters
